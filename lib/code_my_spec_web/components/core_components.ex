defmodule CodeMySpecWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CodeMySpecWeb.Gettext
  ...
  def header(assigns) do
    ~H"""
    <header class={[@actions != [] && "flex justify-between items-center mb-6", "pb-4"]}>
      <div>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CodeMySpecWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CodeMySpecWeb.Gettext, "errors", msg, opts)
    end
  end
