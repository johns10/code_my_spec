...
ExVCR.Config.filter_sensitive_data("Bearer github_pat_[a-zA-Z0-9_]+", "Bearer FILTERED_TOKEN")
ExVCR.Config.filter_sensitive_data("\"Authorization\": \"Bearer [^\"]+\"", "\"Authorization\": \"Bearer FILTERED_TOKEN\"")
